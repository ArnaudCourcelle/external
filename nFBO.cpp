...
CPPEXTERN_NEW_WITH_TWO_ARGS(nFBO, t_symbol *, A_DEFSYMBOL, t_symbol *, A_DEFSYMBOL);
...
//
/////////////////////////////////////////////////////////
nFBO :: nFBO(t_symbol *format, t_symbol *type)
...
//
/////////////////////////////////////////////////////////
void nFBO :: render(GemState *state)
{
...
//
/////////////////////////////////////////////////////////
void nFBO :: postrender(GemState *state)
{
  t_float w, h;
  gem::GLStack*stacks=NULL;
  if(state) {
...
void nFBO::deleteMess(){
	   int j=Tex.size();
		for (int i=0;i<j;i++){
			glDeleteTextures(1,&Tex[i].tex);
			}		
			Tex.clear();	
}
////////////////////////////////////////////////////////
...
//
/////////////////////////////////////////////////////////
void nFBO :: dimMess(int width, int height)
{
...
void nFBO :: colorMess(t_symbol*s,int argc, t_atom*argv)
{
...
void nFBO :: perspectiveMess(t_symbol*s,int argc, t_atom*argv)
{
  switch(argc){
  case 6:
...
void nFBO :: fixFormat(GLenum wantFormat)
{
   m_type = GL_UNSIGNED_BYTE;
...
void nFBO :: formatMess(std::string format)
{
  GLenum tmp_format=0;
  if("YUV"==format) {
...
void nFBO :: typeMess(std::string type)
{
  if("FLOAT"==type) {
    m_type = GL_FLOAT;
  } else {
...
void nFBO :: rectangleMess(bool rectangle)
{
  m_rectangle=rectangle;
  setModified();
}
void nFBO :: texunitMess(int unit) {
...
//
////////////////////////////////////////////////////////
void nFBO :: obj_setupCallback(t_class *classPtr)
{
  ...
  CPPEXTERN_MSG0(classPtr, "delete",   deleteMess);
