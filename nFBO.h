...
#ifndef _INCLUDE__GEM_CONTROLS_nFBO_H_
#define _INCLUDE__GEM_CONTROLS_nFBO_H_
...
class GEM_EXTERN nFBO : public GemBase
{
  CPPEXTERN_HEADER(nFBO, GemBase);

    public:

  //////////
  // Constructor
  nFBO(t_symbol *format, t_symbol *type);
